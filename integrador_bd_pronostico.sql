...
CREATE TABLE `pronostico` (
  ...
  `IdEquipo1` varchar(65) NOT NULL,
  `IdEquipo2` varchar(65) NOT NULL,
  `GolesEquipo1` int NOT NULL,
  `GolesEquipo2` int NOT NULL,
  `Descripcion` varchar(65) DEFAULT NULL,
  `IdEquipoPron` int NOT NULL,
  `IdResultadoPron` int NOT NULL,
...
INSERT INTO `pronostico` VALUES (1,'1','2',3,0,'1',1,1,1,1),(2,'3','4',2,2,'',2,1,1,2),(3,'1','3',3,2,'1',1,1,1,3),(4,'2','4',1,2,'4',1,1,1,4);
